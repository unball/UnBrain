...
#####################
        self.segFrame = SegmentEditor(self.segContents, QPixmap(u"assets/defaultFrame.png"), type="foreground")
...
#####################
        ...
        self.segTeamFrame = SegmentEditor(self.segTeamContents, QPixmap(u"assets/defaultFrame.png"), type="team")
        self.segTeamFrame.setObjectName(u"segTeamFrame")
        sizePolicy7.setHeightForWidth(self.segTeamFrame.sizePolicy().hasHeightForWidth())
        self.segTeamFrame.setSizePolicy(sizePolicy7)
        ...
        self.hueTeamMaxSlider.setValue(179)
        ...
        self.sTeamMinSlider.setValue(0)
        ...
        self.segBallFrame = SegmentEditor(self.segBallContents, QPixmap(u"assets/defaultFrame.png"), type="ball")
        self.segBallFrame.setObjectName(u"segBallFrame")
        sizePolicy7.setHeightForWidth(self.segBallFrame.sizePolicy().hasHeightForWidth())
        self.segBallFrame.setSizePolicy(sizePolicy7)
        ...
        self.hueBallMaxSlider.setValue(82)
        ...
        self.sBallMinSlider.setValue(44)
        ...
        self.vBallMinSlider.setValue(82)
