...
#####################
        self.segFrame = SegmentEditor(self.segContents, u"assets/defaultFrame.png", type="foreground")
...
#####################
        ...
        self.segTeamFrame = SegmentEditor(self.segTeamContents, u"assets/defaultFrame.png", type="team")
        ...
        self.segBallFrame = SegmentEditor(self.segBallContents, u"assets/defaultFrame.png", type="ball")
        ...
        self.hueMaxSlider.valueChanged.connect(self.segFrame.updateMaxHue)
