...
from MainVision.view.strategy.highLevelRenderer import HighLevelRenderer
from MainVision.view.tools.viewMux import ViewMux
from MainVision.controller.states.debugHLC import DebugHLC
from MainVision.controller.tools import norm
from MainVision.helpers import LoopThread
from MainVision.view.tools.plotter import Plotter
import numpy as np
import time
...
class DebugHLCView(LoopThread, StackSelector):
  ...
  def view_worker(self):
    GLib.idle_add(self.loopTimeLabel.set_text, "{:.2f} FPS".format(self.__controllerState.debugData["loopTime"]))
