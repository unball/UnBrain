from MainVision.controller.tools.pixel2metric import meters2pixel, normToAbs
from MainVision.controller.world import Field
import numpy as np
import cv2
...
class Drawing():
  ...
  def draw_ellipse(world, frame, a, b):
    ...
    ellipseAxis = (int(a*width/world.width),int(b*height/world.height))
