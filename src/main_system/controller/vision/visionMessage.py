class VisionMessage():
  ...
  def __init__(self, n_robots):
    ...
    self.debug_baseAngles = [None]*self.n_robots
    """Lista os angulos originais do detalhe para a camisa (antes do offset)"""
  ...
  def setRobot(self, index, pose, internalContours=None, baseAngle=None):
    ...
    if index < self.nRobots:
      ...
      self.debug_baseAngles[index] = baseAngle
