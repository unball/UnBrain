...
class AutomaticReplacer():
    ...
    def send(self, position):
        ...
        isOutside_rr0 = rr[0][0] > robot_pose[0][0] or rr[0][1] > robot_pose[0][1] or rr[0][2] > robot_pose[0][2]
        isOutside_rr1 = rr[1][0] > robot_pose[1][0] or rr[1][1] > robot_pose[1][1] or rr[1][2] > robot_pose[1][2]
        isOutside_rr2 = rr[2][0] > robot_pose[2][0] or rr[2][1] > robot_pose[2][1] or rr[2][2] > robot_pose[2][2]
